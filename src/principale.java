...
public class principale {
	...
	public static void main(String[] args) throws ParseException {
		...
		//CREAZIONE OFFERTE
		gestionale.aggiungiOfferta(new Offerta("Nessuna offerta applicata", 0));
			...
			case 2:
				...
				do {
					...
					case 1: 
				        ...
				        risposta = scanner.nextLine();
					    Offerta offerta = gestionale.getOfferte().get(0);
					    while (risposta.equals("si")) {
						    ...
						    scanner.nextLine();
						    System.out.println();
						    offerta = gestionale.getOfferte().get(idOfferta);
						    break;
					    	}
